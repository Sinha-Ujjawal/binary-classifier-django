"""
Django settings for binary_classifier project.
...
SECRET_KEY = (
    os.getenv("SECRET_KET") or "yd@9qg5u%$$mf)y9()oo)uqq%)9h7=#-45z04k=x@^eo5)jb92"
)
...
ROOT_URLCONF = "binary_classifier.urls"
...
WSGI_APPLICATION = "binary_classifier.wsgi.application"
